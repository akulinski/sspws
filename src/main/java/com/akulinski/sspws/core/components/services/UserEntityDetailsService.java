...
@Service
public class UserEntityDetailsService implements UserDetailsService, Serializable {
    ...
    @Autowired
    public UserEntityDetailsService(UserRepository userRepository, AuthorityRepository authorityRepository) {
